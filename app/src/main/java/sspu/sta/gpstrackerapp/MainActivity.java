...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_showPinList.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(MainActivity.this, ShowPinList.class);
                startActivity(i);
            }
        });
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        switch (requestCode) {
            case PERMISSIONS_FINA_LOCATION:
    ...
    private void updateGPS() {
        ...
        if (ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                requestPermissions(new String[]{Manifest.permission.ACCESS_FINE_LOCATION}, PERMISSIONS_FINA_LOCATION);
            }
        }
    ...
    private void updateUIValues(Location location) {
        ...
        MyApplication MyApplication = (MyApplication)getApplicationContext();
        savedLocations = MyApplication.getMyLocations();
        tv_PinCounter.setText(Integer.toString(savedLocations.size()));
    }
}
